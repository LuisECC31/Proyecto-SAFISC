...
<div class="container ">
 <div class="text-center py-5">
  ...
  <div class="card-header bg-primary col-md-10 text-white" >
    ...
    <form action="?controller=Reportemantenimiento&&action=reporte" method="POST">
        ...
        <div class="row">
            ...
            <form>
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                    <td><input type="text" class="form-control form-control-sm" name="Cedula" value="" size="30" placeholder="Cédula" required/></td>
                    </div></div>
                    <div class="form-group row">
